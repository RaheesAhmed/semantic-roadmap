CREATE PROCEDURE [spq].[GetSMSRestaurantBooking]
    @pBookingRid BIGINT ,
    @pGuid VARCHAR(50) ,
    @pLangCd VARCHAR(30)
AS
    BEGIN
        ...
        LEFT JOIN CRM.dbo.mRestaurant rs ON br.wRestaurantRid = rs.RowID
        LEFT JOIN CRM.dbo.eBooking b ON br.wBookingRid = b.RowID
