CREATE PROCEDURE [spq].[GetSMSTravelPackageBooking]
    @pBookingRid BIGINT ,
    @pGuid VARCHAR(50) ,
    @pLangCd VARCHAR(30)
AS
    BEGIN
        ...
        SELECT  wIsMDAgent = @sIsMDAgent, -- MD轉介戶口
                ...
                tp.wDestCd ,
                tp.wPkgTypeCd ,
                tp.wTravelPkgTypeRid ,
                tpt.wName AS wTravelPackageName ,
                tp.wPaymentMethod ,
                tp.wCurrCode ,
                tp.wExpAmt ,
                tp.wTotalAmt ,
        ...
        FROM    dbo.eBookingTravelPackage tp
                INNER JOIN CRM.dbo.eBooking b ON tp.wBookingRid = b.RowID
                ...
                LEFT JOIN CRM.dbo.mTravelPackageType tpt ON tpt.RowID = tp.wTravelPkgTypeRid
        WHERE   tp.wPkgTypeCd = 'PACKAGE'
