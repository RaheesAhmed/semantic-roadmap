CREATE PROCEDURE [spq].[GetSMSCheckInBooking]
    @pBookingRid BIGINT ,
    @pGuid VARCHAR(50) ,
    @pLangCd VARCHAR(30)
AS
    BEGIN
        ...
        SELECT  wIsMDAgent = @sIsMDAgent, -- MD轉介戶口
                ...
                cis.wRemark ,
                cis.wBookingStatus ,
                cis.wTicketCollectionRid ,
                cis.wBookingDateRid ,
                cis.wServiceCounterRid ,
                cis.wArrivalTimeToG15nG16 ,
                sc_ci.wCode AS wCheckInServiceCounterCode ,
                sc_ci.wSMSName AS wCheckInServiceCounterName ,
                cis.wOrderNo ,
                b.wBookingType ,
                b.wRefNo ,
                b.[GUID] ,
        ...
        FROM    dbo.eBookingCheckInService cis
        LEFT JOIN CRM.dbo.eBooking b ON cis.wBookingRid = b.RowID
        ...
        LEFT JOIN CRM.dbo.mServiceCounter sc_ci ON sc_ci.RowID = cis.wServiceCounterRid
        LEFT JOIN CRM.dbo.eTicketCollection etc ON etc.wBookingRid = cis.wBookingRid
        LEFT JOIN CRM.dbo.mTicketCollectionPoint mtc ON mtc.wCode = etc.wTicCollPoint
        WHERE   b.RowID = @pBookingRid;
    END;