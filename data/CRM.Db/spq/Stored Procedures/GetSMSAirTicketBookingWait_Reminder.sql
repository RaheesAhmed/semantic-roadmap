CREATE PROCEDURE [spq].[GetSMSAirTicketBookingWait_Reminder]
	/*
		EXEC spq.GetSMSAirTicketBookingWait_Reminder '1000044076', N'<DataSet><Record wPassengerRid="10000000010935" wPassengerName="陳小明、陳大陸"/><Record wPassengerRid="10000000010905" wPassengerName="王二"/>', '', 'zh-TW'
