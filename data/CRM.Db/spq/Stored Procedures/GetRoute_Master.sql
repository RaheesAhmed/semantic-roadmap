...
CREATE PROCEDURE [spq].[GetRoute_Master]
    (
    ...
    -- Insert statements for procedure here
        WITH    tResult
                  AS ( SELECT   mr.RowID ,
                                ...
                                CASE WHEN wIsTwoWay = 'Y' THEN lpFrom.wTitle + '<->' + lpTo.wTitle
                       ...
                       FROM     [CRM].[dbo].mRoute mr
                                INNER JOIN mLookUp lpTo ON lpTo.wCode = mr.wRouteTo
                                ...
                                INNER JOIN mLookUp lpFrom ON lpFrom.wCode = mr.wRouteFrom
