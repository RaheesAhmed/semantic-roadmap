CREATE PROCEDURE [spa].[ActionBookingVisa]     
	@pXMLBooking XML = NULL ,      
	@pXMLBookingVisa XML = NULL ,      
	@pXMLVisaCollection XML = NULL ,      
...
BEGIN
	...
	DECLARE @sBeginTranCount INT = 0, 
		@pPassengerId BIGINT = 0;	

	--Select Count(*) as wRecordCount,Count(*) as wRecordCount1  from eBookingVisa
	...
	SET @sBeginTranCount = @@trancount;
	 ...
	 BEGIN TRY
            ...
            IF @sBeginTranCount = 0
				...
				IF @pXMLBookingVisa IS NOT NULL
					EXEC [spa].[SetBookingVisa] @pXMLBookingVisa, @pActionType, @pMainCompNo, @pNonceToken,'N', @pBookingRid, @pVisaInfoId OUTPUT, @pErrCode OUTPUT, @pErrMsg OUTPUT;
				IF @pXMLVisaCollection IS NOT NULL
					EXEC [spa].[SetVisaCollection] @pXMLVisaCollection, @pActionType, @pMainCompNo, @pNonceToken, 'N', @pBookingRid, @pErrCode OUTPUT, @pErrMsg OUTPUT;				
