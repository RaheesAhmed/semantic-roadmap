...
CREATE PROCEDURE [spa].[SetPassengerTravelDocCheckInServices]  
(   
		@pXML XML ,   
     ...
     --     
       ...
       BEGIN TRY 
        ...
        IF @pActionType = 'I'   
			...
			INNER JOIN #sDataSet_SetPassengerTravelDocDetail tmp ON tmp.wSeqNo =pd.wSeqNo AND wBookingRid=@pBookingRid) 
