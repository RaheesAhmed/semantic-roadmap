CREATE PROCEDURE [spa].[SetPerson]
    (
      @pXML XML ,
...
BEGIN
      ...
      ELSE
                IF @pActionType = 'U'
                    BEGIN
                        ...
                        FROM    dbo.mPerson AS met
                                INNER JOIN #sDataSet_SetPerson tmp ON met.RowID = tmp.RowID
                    ...
                    IF @pActionType = 'D'
                        BEGIN						
                           UPDATE dbo.mPerson
                                ...
                                WHERE   RowID IN (SELECT RowID FROM #sDataSet_SetPerson );
                   END;
        ...
        IF OBJECT_ID ('tempdb..#sDataSet_SetPerson') IS NOT NULL DROP TABLE sDataSet_SetPerson;
END;